...
void InstructionSet::emit_binary_op(const std::string& op_instr, char type, const std::string& dest,
    ...
    if (type == 'f' || type == 'l') {
        ...
        if (op_instr == "add")
            fp_op = "add";
        else if (op_instr == "sub")
            fp_op = "sub";
        else if (op_instr == "imul")
            fp_op = "mul";
        else if (op_instr == "idiv")
            fp_op = "div";
...
void InstructionSet::emit_cmp(const std::string& op_instr, const std::string& dest_vreg,
