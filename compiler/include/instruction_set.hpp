...
class InstructionSet {
   ...
   public:
    ...
    void emit_load_constant(const std::string& instr, const std::string& dest_vreg, const std::string& label);
    ...
    void emit_adv(int size, const TypeNode* type, const std::string& base_vreg, int offset, const std::string& src_vreg);
    void load_adv(int size, const TypeNode* type, const std::string& dest_vreg, const std::string& base_vreg, int offset);
    void load_from_address(int size, const TypeNode* type, const std::string& dest_vreg, const std::string& addr_vreg);

    // Logical & Arithmetic
    void emit_binary_op(const std::string& op_instr, char type, const std::string& dest, const std::string& left, const std::string& right);
    void emit_cmp(const std::string& op_instr, const std::string& dest_vreg, const std::string& left_vreg, const std::string& right_vreg, bool is_string_compare);
    ...
    void emit_print_raw(int size, const std::shared_ptr<TypeNode>& type, const std::string& src_vreg);
};
