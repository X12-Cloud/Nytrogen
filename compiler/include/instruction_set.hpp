...
class InstructionSet {
   ...
   public:
    ...
    // Printing
    void emit_print(int size, const std::shared_ptr<TypeNode>& type, const std::string& src_vreg, const std::string& outs);
    ...
    void emit_print_internal(int size, const std::shared_ptr<TypeNode>& type,
                                         const std::string& src_vreg, bool is_raw, const std::string& outs);
};
